...
GraphQLClient getGithubGraphQLClient() {
  final Link _link = HttpLink(
    'http://192.168.100.218:4000/graphql',
    /*
    defaultHeaders: {
...
/// query example - fetch all your boards
Future<List> readBoards() async {
  ...
  final List<dynamic> boards = result.data!['boards'] as List<dynamic>;
  return boards;
}

void main() {
  readBoards().then((List l) {
    l.forEach((element) {
